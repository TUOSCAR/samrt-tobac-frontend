...
// 页面组件 - 大模型分析
const AnomalyDiagnosis = () => import('@/views/llm/AnomalyDiagnosis.vue')
const StrategyRecommendation = () => import('@/views/llm/StrategyRecommendation.vue')
const AnalysisReport = () => import('@/views/llm/AnalysisReport.vue')
const MonitoringPlan = () => import('@/views/llm/MonitoringPlan.vue')
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'ExecutionTaskDetail',
        component: ExecutionTaskDetail,
        meta: {
          title: '执行任务详情',
          requiresAuth: true,
          roles: ['admin', 'technician', 'farmer']
      ...
      {
        path: 'execution/tasks/:id/review',
        name: 'FeedbackReview',
